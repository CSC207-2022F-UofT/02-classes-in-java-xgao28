...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param str1 the first string for this Silly instance's name.
     * @param str2 the second string for this Silly instance's name.
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        int tlen = this.name.length();
        int olen = other.name.length();
        return tlen - olen;
    }
